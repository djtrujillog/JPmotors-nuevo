...
const Clientes = () => {
  ...
  const addCliente = async () => {
    try {
      await axios.post('https://cotizaciones-jpmotors.onrender.com/clientes', form);
    } catch (error) {
  ...
  const updateCliente = async () => {
    try {
      await axios.put(`https://cotizaciones-jpmotors.onrender.com/clientes/${currentClienteId}`, form);
    } catch (error) {
  ...
  const deleteCliente = async (id) => {
    try {
      await axios.delete(`https://cotizaciones-jpmotors.onrender.com/clientes/${id}`);
      fetchClientes();
    } catch (error) {
