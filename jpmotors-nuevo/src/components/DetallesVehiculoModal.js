...
const DetallesVehiculoModal = ({ show, handleClose, vehiculo }) => {
  ...
  const fetchExistingDetalles = async (VehiculoID) => {
    try {
      const response = await axios.get(`https://cotizaciones-jpmotors.onrender.com/vehiculos/detalleDimensiones/${VehiculoID}`);
  ...
  const eliminarDetalle = async (descripcion) => {
    try {
      ...
      await axios.post('https://cotizaciones-jpmotors.onrender.com/vehiculos/borrarDimensiones', body);
  ...
  const handleEditDetalle = async () => {
    try {
      ...
      await axios.put(`https://cotizaciones-jpmotors.onrender.com/vehiculos/detalleDimensiones/${encodeURIComponent(originalDetalle)}`, body);
  ...
  const handleAgregarDetalle = async () => {
    try {
      ...
      const response = await axios.post('https://cotizaciones-jpmotors.onrender.com/vehiculos/detalleDimensiones', body);
