...
const DetallesVehiculoExteriorModal = ({ show, handleClose, vehiculo }) => {
  ...
  const fetchExistingDetalles = async (VehiculoID) => {
    try {
      const response = await axios.get(`https://cotizaciones-jpmotors.onrender.com/vehiculos/detalleExterior/${VehiculoID}`);
      if (response.data) {
  ...
  const eliminarDetalle = async (descripcion) => {
    try {
      ...
      await axios.post('https://cotizaciones-jpmotors.onrender.com/vehiculos/eliminarExterior', body);
  ...
  const handleEditDetalle = async () => {
    try {
      ...
      await axios.put(`https://cotizaciones-jpmotors.onrender.com/vehiculos/detalleExterior/${encodeURIComponent(originalDetalle)}`, body);
  ...
  const handleAgregarDetalle = async () => {
    try {
      ...
      const response = await axios.post('https://cotizaciones-jpmotors.onrender.com/vehiculos/detalleExterior', body);
