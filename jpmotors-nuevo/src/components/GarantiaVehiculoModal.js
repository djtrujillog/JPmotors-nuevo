...
const DetallesVehiculoGarantia = ({ show, handleClose, vehiculo }) => {
  ...
  const handleEditDetalle = async () => {
    try {
      ...
      await axios.put(`https://cotizaciones-jpmotors.onrender.com/vehiculos/detalleGarantia/${encodeURIComponent(originalDetalle)}`, body);
  ...
  const handleAgregarDetalle = async () => {
    try {
      ...
      const response = await axios.post('https://cotizaciones-jpmotors.onrender.com/vehiculos/detalleGarantia', body);
