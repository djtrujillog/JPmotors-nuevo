...
const DetallesVehiculoMotorModal = ({ show, handleClose, vehiculo }) => {
  ...
  const fetchExistingDetalles = async (VehiculoID) => {
    try {
      const response = await axios.get(`https://jpmotorsgt.azurewebsites.net/vehiculos/detalleMotor/${VehiculoID}`);
      if (response.data) {
  ...
  const eliminarDetalle = async (descripcion) => {
    try {
      ...
      await axios.post('https://jpmotorsgt.azurewebsites.net/vehiculos/eliminarMotor', body);
  ...
  const handleEditDetalle = async () => {
    try {
      ...
      await axios.put(`https://jpmotorsgt.azurewebsites.net/vehiculos/detalleMotor/${encodeURIComponent(originalDetalle)}`, body);
  ...
  const handleAgregarDetalle = async () => {
    try {
      ...
      const response = await axios.post('https://jpmotorsgt.azurewebsites.net/vehiculos/detalleMotor', body);
