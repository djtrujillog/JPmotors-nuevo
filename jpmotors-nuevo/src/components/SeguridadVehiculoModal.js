...
const DetallesVehiculoSeguridadModal = ({ show, handleClose, vehiculo }) => {
  ...
  const fetchExistingDetalles = async (VehiculoID) => {
    try {
      const response = await axios.get(`https://jpmotorsgt.azurewebsites.net/vehiculos/detalleSeguridad/${VehiculoID}`);
      if (response.data) {
  ...
  const eliminarDetalle = async (descripcion) => {
    try {
      ...
      await axios.post('https://jpmotorsgt.azurewebsites.net/vehiculos/eliminarSeguridad', body);
  ...
  const handleEditDetalle = async () => {
    try {
      ...
      await axios.put(`https://jpmotorsgt.azurewebsites.net/vehiculos/detalleSeguridad/${encodeURIComponent(originalDetalle)}`, body);
  ...
  const handleAgregarDetalle = async () => {
    try {
      ...
      const response = await axios.post('https://jpmotorsgt.azurewebsites.net/vehiculos/detalleSeguridad', body);
